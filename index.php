    ...
    <div id="carouselHome" class="mt-4 carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="2000">
                <img src="assets/images/benner1.jpg" class="d-block w-100" alt="benner 1">
            </div>
            <div class="carousel-item" data-bs-interval="2000">
                <img src="assets/images/benner2.jpg" class="d-block w-100" alt="benner 2">
            </div>
            <div class="carousel-item" data-bs-interval="2000">
                <img src="assets/images/benner3.jpg" class="d-block w-100" alt="benner 3">
            </div>
        </div>
    </div>
